...
export const metadata = {
  title: "Limitless Wear - Магазин лимитированной одежды",
  description: "Limitless Wear - интернет-магазин брендовой одежды, обуви и аксессуаров. Широкий выбор оригинальных товаров от ведущих мировых брендов с доставкой по всей России.",
  keywords: "Limitless Wear, одежда, обувь, аксессуары, брендовая одежда, интернет-магазин одежды, модная одежда, стильная одежда"
};
